1. In ADT, Right click Package: `ZRAP_ISLM_###` and choose **New** > **ABAP Class**:

![alt text](./img/image.png)

![alt text](./img/image-1.png)

- Name: `ZCL_DN_EXTRACT_###`

- Description: `Class to extract data from S4`

![alt text](./img/image-2.png)

![alt text](./img/image-3.png)

2. Please click on **Save** and **Activate** button to save and activate the custom entity.

3. Replace the code of class `ZCL_DN_EXTRACT_###` with following code

```
CLASS zcl_dn_extract_### DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  PUBLIC SECTION.
...
CLASS zcl_dn_extract_### IMPLEMENTATION.

  METHOD if_rap_query_provider~select.

    DATA:
      lt_business_data         TYPE TABLE OF zrap_islm_sc_dn_###=>tys_a_outb_delivery_header_typ,
      wa_business_data         TYPE zrap_islm_sc_dn_###=>tys_a_outb_delivery_header_typ,
      ...
      lt_business_data_address TYPE TABLE OF zrap_islm_sc_dn_###=>tys_a_outb_delivery_address__2,
      wa_business_data_address TYPE  zrap_islm_sc_dn_###=>tys_a_outb_delivery_address__2,
    ...
    DATA:
      ...
      lt_range_delivery_date     TYPE RANGE OF zdn_header_###-delivery_date.
    ...
    DATA :it_dn_response         TYPE STANDARD TABLE OF zdn_header_###,
          wa_dn_response         TYPE zdn_header_###,
          it_dn_items_response   TYPE STANDARD TABLE OF zdn_item_###,
          wa_dn_items_response   TYPE  zdn_item_###,
          it_dn_address_response TYPE STANDARD TABLE OF zdn_address_###,
          wa_dn_address_response TYPE  zdn_address_###,
...
> Note: If there is error in activation, please redo this after the custom entities has been created in next excercise.
